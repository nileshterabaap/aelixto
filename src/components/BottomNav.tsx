      ...
      <div className="relative mx-auto max-w-md">
        ...
        <div className="grid grid-cols-5 place-items-center h-20 px-4">
          ...
          >
            ...
            />
            {/* red badge */}
            <span className="absolute top-0 right-1 inline-flex h-4 min-w-4 items-center justify-center rounded-full bg-red-500 px-[5px] text-[10px] font-bold leading-none text-white ring-2 ring-white">
              7
            </span>
          </Button>
