...
const Profile = () => {
  ...
  return (
    <div className="min-h-screen bg-background pb-24">
      ...
      <div className="relative h-64 bg-cover bg-center" style={{ backgroundImage: `url(${profileHeaderBg})` }}>
      ...
      <div className="relative -mt-12 bg-background rounded-t-[3rem] pt-20 pb-8">
        ...
        {/* Edit Profile Button */}
        <Button className="mt-6 w-full max-w-xs rounded-full h-10 text-sm font-bold bg-white text-foreground hover:bg-white/90 shadow-[0_4px_12px_rgba(0,0,0,0.15)] border border-border">
          Edit Profile
        </Button>
