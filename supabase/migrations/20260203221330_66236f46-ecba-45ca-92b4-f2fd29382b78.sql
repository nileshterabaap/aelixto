-- ERROR FIX: Postgres cannot change a function's OUT-parameter row type via CREATE OR REPLACE.
-- Drop then recreate with the expanded return columns.
...
AS $function$
  WITH following_posts AS (
    ...
    SELECT 
      ...
      pr_reposter.username as reposted_by_username,
