...
REVOKE EXECUTE ON FUNCTION public.has_unseen_following_feed_posts() FROM PUBLIC, anon;
GRANT EXECUTE ON FUNCTION public.has_unseen_following_feed_posts() TO authenticated;
