...
- `resources/icon-only.png` — 1024x1024 app icon (Aelixto mark on white)
...
The filename `icon-only.png` is required by Capacitor's asset generator. The
command explicitly reads the `resources/` folder and overwrites
